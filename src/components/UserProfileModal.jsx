...
import { X, ShieldCheck, User, Mail, Phone, Calendar, Key, CheckCircle, Code, LogOut, ExternalLink, Copy } from 'lucide-react';
  ...
  return (
    <div className="modal-overlay" onClick={closeProfileModal} style={{ zIndex: 1200 }}>
      <div 
        ...
        style={{ maxWidth: '560px', padding: '0', overflow: 'hidden', border: '1px solid rgba(0, 200, 140, 0.3)' }}
      >
        {/* Profile Card Header */}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', color: 'var(--primary-green)', marginTop: '4px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                <CheckCircle size={13} /> Tài khoản đã được cấp phép hoạt động
              </div>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'summary' ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 14px', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: '11.5px', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Zalo User ID (UID)</div>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Dữ liệu JSON phản hồi từ Zalo Graph API:</span>
                <button onClick={copyJson} style={{ background: 'rgba(0, 200, 140, 0.15)', color: 'var(--primary-green)', padding: '4px 8px', borderRadius: '4px', fontSize: '12px', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}>
